...
Knoten werden bevorzugt aus den weniger fitten Individuen ausgewählt. Alle lebenden Knoten (inkl. Root)
können in jeder Generation Nachkommen erzeugen, bis die maximale Population erreicht ist. Verstorbene
Individuen verbleiben im Baum, werden dort als "verstorben" markiert und erzeugen keine weiteren Nachkommen.
Der Baum kann als JSON gespeichert/​geladen und mit Graphviz visualisiert werden.
"""
...
class Simulator:
    ...
    gut lesbare Teile zu splitten. Berücksichtigt dabei eine maximale Populationsgröße
    und fitness-basierte Eliminierung.
    """
    ...
    def simulate(self) -> MutationTree:
        ...
        2. Für jede Generation:
           a) Nachkommen generieren, bis max_population erreicht ist.
    ...
    def _generate_offspring_to_capacity(self) -> None:
        ...
        Falls bereits die Kapazität erreicht ist, passiert nichts.
        """
        ...
        # Für jeden neuen Nachkommen einen zufälligen Elternknoten wählen
    ...
    def _apply_elimination_exact(self) -> None:
        ...
        # Berechne Anzahl der zu eliminierenden Knoten
