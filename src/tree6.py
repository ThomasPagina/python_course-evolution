...
Die Fitness-Funktion bevorzugt jetzt Knoten mit einer hohen Anzahl an 'b'-Zeichen.
"""
...
class TreeNode:
    ...
    def fitness(self) -> float:
        """
        Berechnet die Fitness anhand der Anzahl der 'b'-Zeichen.
        Je mehr 'b'-Zeichen im String, desto höher die Fitness.
        Fitness = (Anzahl 'b' oder 'B') / (Länge der Sequenz).
        """
        count_b = self.sequence.lower().count('b')
        return count_b / len(self.sequence)
...
class Simulator:
    ...
    - Fitness-basierte Eliminierung basierend auf 'b'-Anzahl
    ...
    def simulate(self) -> MutationTree:
        ...
        2. Für jede Generation:
           ...
           b) Eliminierung basierend auf Fitness (b-Anteil) und definierter Eliminationsrate.
        """
    ...
    def _apply_elimination_exact(self) -> None:
        ...
        basierend auf der Anzahl der 'b' im String.
        """
        alive_ids = self.tree.alive_nodes()
        ...
        # Sortiere lebende Knoten nach Fitness aufsteigend (weniger 'b'-dominant zuerst)
